...
class DonationsView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('..\controllers/DonationsController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f50756504bc05b9a'
  ...
  render() {
    const proxies = DonationsView.Controller !== DonationsView ? transformProxies(this.props.children) : {
      ...
      <span>
        ...
        <span className="af-view">
          <div>
                  ...
                  <div className="af-class-nav-wrapper">
                    ...
                    <div className="af-class-cart-nav-wrapper">
                      <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                        ...
                        <a href="donations.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Donate</a>
            ...
            <div className="af-class-donate-explainer">
              <div className="af-class-container">
                <div className="af-class-donate-heading-1">Here at Acme Outdoors</div>
                <div className="af-class-donate-heading-2">every dollar counts</div>
                <p className="af-class-donate-paragraph">Acme Outdoors is more than just a company, we're a community of people who care for one another and for our city. During this time, due to shelter in place orders, only a select few of our staff are able to work. Any donations you make to Acme will help make sure our employees are cared for and can stay safe in these uncertain times. </p>
              </div>
            </div>
            <div className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-donate-wrapper">
                  <div className="af-class-donate-collection w-dyn-list">
                    <div role="list" className="w-dyn-items">
                      <div role="listitem" className="w-dyn-item">
                        <a href="#" className="af-class-donate-link-block w-inline-block">
