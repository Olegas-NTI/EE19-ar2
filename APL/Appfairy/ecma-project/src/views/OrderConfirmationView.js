...
class OrderConfirmationView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f50756876ec05b98'
        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-content-section">
              <div data-node-type="commerce-order-confirmation-wrapper" data-wf-order-query data-wf-page-link-href-prefix className="w-commerce-commerceorderconfirmationcontainer af-class-order-confirmation">
                <div className="w-commerce-commercelayoutcontainer af-class-container-checkout w-container">
                  <div className="w-commerce-commercelayoutmain">
                    ...
                    <div className="w-commerce-commercecheckoutorderitemswrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent">
                        <div className="w-commerce-commercecheckoutorderitemslist af-class-order-item-list" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-5e853c3379b34f063f675eee000000000051" />
                      </fieldset>
                    </div>
                  </div>
                  <div className="w-commerce-commercelayoutsidebar">
                    <div className="w-commerce-commercecheckoutordersummarywrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent">
                        ...
                        <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-5e853c3379b34f063f675eee00000000006b">
