...
class DetailAlertView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('..\controllers/DetailAlertController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507567977c05b9c'
  ...
  render() {
    const proxies = DetailAlertView.Controller !== DetailAlertView ? transformProxies(this.props.children) : {
...
export default DetailAlertView
