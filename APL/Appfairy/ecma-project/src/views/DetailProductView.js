...
class DetailProductView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507562a47c05b94'
        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-shopping-page-wrapper">
                  <div className="af-class-shopping-page-left">
                    <div className="af-class-shopping-page-image">
                      <div className="af-class-pill-2 af-class-badge af-class-primary af-class-sale">Sale</div>
                    </div>
                  </div>
                  <div className="af-class-shipping-page-right">
                    <h2 className="af-class-page-product-headin" />
                    <div className="af-class-page-price-wrapping">
                      <div className="af-class-shop-item-price-page" />
                      <div className="af-class-shop-item-price-page af-class-compare-at" />
                    </div>
                    <div>
                      <form data-node-type="commerce-add-to-cart-form" className="w-commerce-commerceaddtocartform"><label htmlFor="quantity-8342fe54ad998bceba4bd86dd02b8e79">Quantity</label>
                        <div className="af-class-add-to-cart-page-wrapper"><input type="number" pattern="^[0-9]+$" inputMode="numeric" id="quantity-8342fe54ad998bceba4bd86dd02b8e79" name="commerce-add-to-cart-quantity-input" min={1} className="w-commerce-commerceaddtocartquantityinput af-class-input af-class-cart-quantity" defaultValue={1} /><input type="submit" defaultValue="Add To Cart" data-node-type="commerce-add-to-cart-button" data-loading-text="Adding to cart..." className="w-commerce-commerceaddtocartbutton af-class-btn af-class-outline" /></div>
                      </form>
                    ...
                    <div>
                      <h3 className="af-class-page-product-headin">Tweet about #AcmeOutdoors products</h3>
                      <div className="w-widget w-widget-twitter"><iframe allowTransparency="true" frameBorder={0} scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.html#counturl=biznus-template.io&dnt=true&height=28&show_count=false&size=l&text=You'll%20love%20the%20product%20from%20Acme%20Outdoors!&url=http%3A%2F%2Fbiznus-template.io&width=76" style={{border: 'none', height: 28, overflow: 'hidden', width: 76}} /></div>
                    </div>
                  </div>
                </div>
              </div>
