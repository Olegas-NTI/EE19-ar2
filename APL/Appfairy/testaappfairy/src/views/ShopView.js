...
class ShopView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507566da9c05b99'
        ...
        <span className="af-view">
          <div>
                  ...
                  <div className="af-class-nav-wrapper">
                    ...
                    <div className="af-class-cart-nav-wrapper">
                      <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                        ...
                        <a href="shop.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Shop</a>
            ...
            <div className="af-class-page-title-section">
              <div className="af-class-container">
                <h1 className="af-class-page-title">Shop Our Products</h1>
              </div>
            </div>
            <div className="af-class-content-section af-class-featured-section">
              <div className="af-class-container">
                <div className="w-dyn-list">
                  <div role="list" className="w-dyn-items">
                    <div role="listitem" className="w-dyn-item">
                      <a href="#" className="af-class-featured-wrapper w-inline-block">
                        <div className="af-class-pill-2 af-class-badge af-class-primary af-class-featured">Featured Item</div>
                        <div className="af-class-feature-text-wrapper">
                          <h3 className="af-class-featured-item-name" />
                          <div className="af-class-featured-price" />
                        </div>
                        <div className="af-class-featured-gradient-overlay" />
                      </a>
                    </div>
                  </div>
            ...
            <div className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-shop-page-wrapper">
                  <div className="af-class-shop-category-menu">
                    <h2 className="af-class-category-menu-heading">Shop by Category</h2>
                    <div className="w-dyn-list">
                      <div role="list" className="w-dyn-items">
                        <div role="listitem" className="af-class-category-menu-item w-dyn-item">
                          <a href="#" className="af-class-btn af-class-dark af-class-outline af-class-cat-menu w-button" />
                        </div>
                      </div>
                      <div className="w-dyn-empty">
                        <div>No items found.</div>
                  ...
                  <div className="af-class-shop-list">
                        ...
                        <div role="listitem" className="w-dyn-item">
                          <div className="af-class-shop-item-wrapper">
                            <a href="#" className="af-class-shop-item-link-wrapper w-inline-block">
                              <div className="af-class-shop-image af-class-tumbler-1 af-class-narrow-list">
