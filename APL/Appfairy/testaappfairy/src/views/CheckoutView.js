...
class CheckoutView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507565201c05b96'
                ...
                <div className="w-commerce-commercelayoutcontainer af-class-container-checkout w-container">
                  <div className="w-commerce-commercelayoutmain">
                    <div data-node-type="commerce-cart-quick-checkout-actions">
                      ...
                      <a data-node-type="commerce-cart-quick-checkout-button" style={{display: 'none'}} className="w-commerce-commercecartquickcheckoutbutton af-class-pay-with-browser"><svg className="w-commerce-commercequickcheckoutgoogleicon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={16} height={16} viewBox="0 0 16 16">
                          <defs>
                            <polygon id="google-mark-a" points="0 .329 3.494 .329 3.494 7.649 0 7.649" />
                            <polygon id="google-mark-c" points=".894 0 13.169 0 13.169 6.443 .894 6.443" />
                          </defs>
                    ...
                    <form data-node-type="commerce-checkout-customer-info-wrapper" className="w-commerce-commercecheckoutcustomerinfowrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel">Email *</label><input type="text" name="email" required className="w-commerce-commercecheckoutemailinput af-class-input" /></fieldset>
                    </form>
                    <form data-node-type="commerce-checkout-shipping-address-wrapper" className="w-commerce-commercecheckoutshippingaddresswrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutshippingfullname af-class-input" /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutshippingstreetaddress af-class-input" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutshippingstreetaddressoptional af-class-input" />
                        <div className="w-commerce-commercecheckoutrow af-class-row">
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">City *</label><input type="text" name="address_city" required className="w-commerce-commercecheckoutshippingcity af-class-input" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" name="address_state" className="w-commerce-commercecheckoutshippingstateprovince af-class-input" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" name="address_zip" required data-node-type="commerce-checkout-shipping-zip-field" className="w-commerce-commercecheckoutshippingzippostalcode af-class-input" /></div>
                        </div><label className="w-commerce-commercecheckoutlabel">Country *</label><select name="address_country" className="w-commerce-commercecheckoutshippingcountryselector af-class-input">
                    ...
                    <form data-node-type="commerce-checkout-shipping-methods-wrapper" className="w-commerce-commercecheckoutshippingmethodswrapper">
                      ...
                      <fieldset className="af-class-block-content">
                        <div data-node-type="commerce-checkout-shipping-methods-list" className="w-commerce-commercecheckoutshippingmethodslist" data-wf-collection="database.commerceOrder.availableShippingMethods" data-wf-template-id="wf-template-5e853c3379b34ff1c6675eea000000000042"><label className="w-commerce-commercecheckoutshippingmethoditem"><input type="radio" required name="shipping-method-choice" />
                    ...
                    <div className="w-commerce-commercecheckoutpaymentinfowrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel">Card Number *</label>
                        <div data-wf-stripe-element-type="cardNumber" data-wf-style-map="{}" style={{position: 'relative'}} className="w-commerce-commercecheckoutcardnumber af-class-input">
                          <div />
                        ...
                        <div className="w-commerce-commercecheckoutrow">
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Expiration Date *</label>
                            <div data-wf-stripe-element-type="cardExpiry" data-wf-style-map="{}" style={{position: 'relative'}} className="w-commerce-commercecheckoutcardexpirationdate af-class-input">
                              <div />
                              <div style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0}} />
                            </div>
                          </div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Security Code *</label>
                            <div data-wf-stripe-element-type="cardCvc" data-wf-style-map="{}" style={{position: 'relative'}} className="w-commerce-commercecheckoutcardsecuritycode af-class-input">
                              <div />
                              <div style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0}} />
                            </div>
                          </div>
                        </div>
                        <div className="w-commerce-commercecheckoutbillingaddresstogglewrapper"><input type="checkbox" defaultChecked id="billing-address-toggle" data-node-type="commerce-checkout-billing-address-toggle-checkbox" className="w-commerce-commercecheckoutbillingaddresstogglecheckbox" /><label htmlFor="billing-address-toggle" className="w-commerce-commercecheckoutbillingaddresstogglelabel">Billing address same as shipping</label></div>
                      </fieldset>
                    </div>
                    <form data-node-type="commerce-checkout-billing-address-wrapper" style={{display: 'none'}} className="w-commerce-commercecheckoutbillingaddresswrapper">
                      <div className="w-commerce-commercecheckoutblockheader af-class-block-header">
                        <h4>Billing Address</h4>
                        <div>* Required</div>
                      </div>
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutbillingfullname af-class-input" /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutbillingstreetaddress af-class-input" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutbillingstreetaddressoptional af-class-input" />
                        <div className="w-commerce-commercecheckoutrow">
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">City *</label><input type="text" name="address_city" required className="w-commerce-commercecheckoutbillingcity af-class-input" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" name="address_state" className="w-commerce-commercecheckoutbillingstateprovince af-class-input" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" name="address_zip" required data-node-type="commerce-checkout-billing-zip-field" className="w-commerce-commercecheckoutbillingzippostalcode af-class-input" /></div>
                        </div><label className="w-commerce-commercecheckoutlabel">Country *</label><select name="address_country" className="w-commerce-commercecheckoutbillingcountryselector af-class-input">
                          <option value="AF">Afghanistan</option>
                          <option value="AX">Aland Islands</option>
                          <option value="AL">Albania</option>
                          <option value="DZ">Algeria</option>
                    ...
                    <div className="w-commerce-commercecheckoutorderitemswrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content">
                        <div className="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-5e853c3379b34ff1c6675eea000000000086" />
                      </fieldset>
                    </div>
                  </div>
                  <div className="w-commerce-commercelayoutsidebar">
                    <div className="w-commerce-commercecheckoutordersummarywrapper">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content">
                        ...
                        <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-5e853c3379b34ff1c6675eea0000000000a0">
                    ...
                    <div data-node-type="commerce-checkout-error-state" style={{display: 'none'}} className="w-commerce-commercecheckouterrorstate af-class-alert-wrapper af-class-danger">
