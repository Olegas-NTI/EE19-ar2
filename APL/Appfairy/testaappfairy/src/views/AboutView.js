...
class AboutView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507567e34c05b90'
      ...
      <span>
        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-hero-section af-class-about-hero">
              <div className="af-class-container">
                <div className="af-class-hero-wrapper">
                  <h1 className="af-class-hero-heading af-class-anout-hero-heading">Your Adventure<br />Awaits</h1>
                  <p className="af-class-hero-paragraph">Acme Outdoors has everything you need to help you get started today. Check out our wonderful collection of gear that will make your next adventure complete.</p>
            ...
            <div className="af-class-content-section af-class-why-acme-sections">
              <div className="af-class-container">
                <div className="af-class-about-top-block">
                  <div className="af-class-why-acme-block">
                    <div className="af-class-why-acme-small-text">Why Acme Outdoors?</div>
                    <h2 className="af-class-why-acme-heading">We’re the best in the business.</h2>
                    <p className="af-class-why-acme-paragraph">From more than 30 years, we’ve been leading the way across Oklahoma — creating the best possible customer experience since 1989.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-about-columns-wrapper">
                  <div className="af-class-about-column"><img src="images/verified.svg" alt="Warranty Icon" className="af-class-image" />
                    <h3>Lifetime Warranty</h3>
                    <p>All our products — whether we make them or not — are backed by our lifetime warranty.</p>
                  </div>
                  <div className="af-class-about-column"><img src="images/cart.svg" alt="Shopping Cart Icon" className="af-class-image" />
                    <h3>Shopping Experience</h3>
                    <p>All our products — whether we make them or not — are backed by our lifetime warranty.</p>
                  </div>
                  <div className="af-class-about-column"><img src="images/transport.svg" alt="Delivery Icon" className="af-class-image" />
                    <h3>On-time Delivery</h3>
                    <p>All our products — whether we make them or not — are backed by our lifetime warranty.</p>
                  </div>
                  <div className="af-class-about-column"><img src="images/chat-alt.svg" alt="Service Icon" className="af-class-image" />
            ...
            <div className="af-class-content-section">
              <div className="af-class-container af-class-shop-local-container">
                <div className="af-class-content-wrapper">
                  <div className="af-class-meet-the-owners-wrapper">
                    <div className="af-class-meet-the-owners-left" />
                    <div className="af-class-meet-the-owners-right">
                      <div className="af-class-owners-rich-text w-richtext">
            ...
            <div className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-owner-bios-wrapper">
                  <div className="af-class-owner-bio">
                    <div className="af-class-owner-avatar-wrapper"><img src="images/John-Doe.png" alt="Co-Owner John Doe" /></div>
                    <h3>John Doe</h3>
                    <p className="af-class-owner-bio-paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                  </div>
                  <div className="af-class-owner-bio">
                    <div className="af-class-owner-avatar-wrapper"><img src="images/Jane-Doe.png" alt="Co-Owner Jane Doe" /></div>
                    <h3>Jane Doe</h3>
                    <p className="af-class-owner-bio-paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                  </div>
                </div>
            ...
            <div className="af-class-hero-section af-class-contact-hero">
              <div className="af-class-container">
                <div className="af-class-hero-wrapper">
                  <h1 className="af-class-hero-heading af-class-anout-hero-heading">Need Help?</h1>
                  <p className="af-class-hero-paragraph">Need help or assistance?&nbsp;Our team is standing by to make sure you get the help you need. Whether you need to adjust an order or delivery details, we're ready to help!</p>
                  <div className="af-class-hero-button-wrapper">
                    <a href="contact.html" className="af-class-btn af-class-light af-class-outline w-button">Contact Support</a>
                  </div>
                </div>
              </div>
            </div>
