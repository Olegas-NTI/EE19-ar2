...
class DetailTestColectionView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('..\controllers/DetailTestColectionController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = DetailTestColectionView
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6010313288b93134d320ef6b'
  ...
  render() {
    const proxies = DetailTestColectionView.Controller !== DetailTestColectionView ? transformProxies(this.props.children) : {
...
export default DetailTestColectionView
