...
class ContactView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f5075622aec05b91'
      ...
      <span>
        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-contact-hero-section">
              <div className="af-class-contact-hero-bg-wrapper">
                <div className="af-class-container af-class-contact">
                  <h1 className="af-class-heading">Contact Acme Outdoors</h1>
                  <div className="af-class-contact-block-wrapper">
                    <div className="af-class-contact-block"><img src="images/chat-alt.svg" alt className="af-class-contact-icon" />
                      <h2>Contact Us</h2>
                      <p>Just want to say hi?&nbsp;We'd love to hear from you. We love our customers and community!&nbsp;</p>
                      <a href="#contact" className="af-class-btn w-button">Send Us A Message</a>
                    </div>
                    <div className="af-class-contact-block"><img src="images/chat-warning.svg" alt className="af-class-contact-icon" />
                      <h2>Get Support</h2>
                      <p>Have an issue with an order or with a product you purchased from us?&nbsp;Fill out our support form.</p>
                      <a href="https://university.webflow.com/support" target="_blank" className="af-class-btn w-button">Contact Support</a>
                    </div>
                  </div>
                </div>
                <div className="af-class-contact-image-div" />
              </div>
            </div>
            <div id="contact" className="af-class-content-section">
              <div className="af-class-container">
                <div className="af-class-contact-wrapper">
                  <div className="af-class-contact-left">
                    <h2>Contact Us</h2>
                  ...
                  <div className="af-class-contact-right">
                    <h2>Contact Form</h2>
                    <p>Send us a message and we'll get back to you as soon as we can! </p>
                    <div className="w-form">
                      <form id="email-form" name="email-form" data-name="Email Form"><label htmlFor="name">Name</label><input type="text" className="af-class-input w-input" maxLength={256} name="name" data-name="Name" placeholder="Enter your name" id="name" /><label htmlFor="email">Email Address</label><input type="email" className="af-class-input w-input" maxLength={256} name="email" data-name="Email" placeholder="Enter your email address" id="email" required /><label htmlFor="Message">Your Message</label><textarea placeholder="Enter your message" maxLength={5000} id="Message" name="Message" data-name="Message" className="af-class-input w-input" defaultValue={""} /><input type="submit" defaultValue="Submit" data-wait="Please wait..." className="af-class-btn w-button" /></form>
                      <div className="af-class-success w-form-done">
                        <div>Thank you! Your submission has been received! We'll be in touch soon!</div>
                      </div>
                      <div className="af-class-error w-form-fail">
