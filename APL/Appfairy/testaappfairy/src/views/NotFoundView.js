...
class NotFoundView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60102a28f507561e2dc05b9d'
        ...
        <span className="af-view">
          <div>
            <div className="af-class-utility-page-wrap">
              <div className="af-class-utility-page-content w-form"><img src="images/danger.svg" alt />
                <h2>So sorry! We can't find that page</h2>
                <p>The page you are looking for doesn't exist or has been moved. You can go back to the <a href="index.html">home page</a>, or you can contact us and let us know about <a href="contact.html">this error</a>.</p>
              </div>
            </div>
            {/* [if lte IE 9]><![endif] */}
          </div>
